...
void draw_playing_field() {
    ...
    //SDL_SetRenderDrawColor(render, 255, 179, 192, 204);
...
bool render_current_tetromino(Tetromino_Movement tetra_request) {
    ...
    // change alpha to ~50%
    ghost.color = ghost.color & 0xFFFFFF00;
    //ghost.color = ghost.color | 0x66000000;
    ghost.color = ghost.color | 0x00000033;
    ...
    // change alpha to 90%
    tetra_request.type.color = tetra_request.type.color & 0xFFFFFF00;
    tetra_request.type.color = tetra_request.type.color | 0x000000E5;
